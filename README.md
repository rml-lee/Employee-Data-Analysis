...
# Business Objective
This analysis will gather actionable insights and identify trends from the provided Human Resources (HR) dataset, taking a deeper dive into recruitment efficiency and employee retention drivers. The goal is to pinpoint the most effective hiring sources and evaluate management performance based on employee survey scores. This will enable data-driven strategies to optimize talent acquisition and improve management performance for reduced operational costs and a stronger workforce.
...
You can review the results [here](https://github.com/rml-lee/MYSQL-Tableau-Human-Resources-Project/blob/main/Findings-Analysis.md).
